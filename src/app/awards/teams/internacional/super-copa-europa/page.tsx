...
function SuperCup() {
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100 text-gray-800 py-10 px-4">
      ...
      {/* Image */}
      <div className="mb-8 w-64 h-64 relative rounded-full overflow-hidden shadow-lg">
        <Image src={SuperCupImg} alt="UEFA Super Cup" layout="fill" objectFit="cover" className="rounded-full" />
      </div>
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg text-center mb-8 max-w-md w-full border border-gray-200">
        ...
        <div className="space-y-4 text-xl">
          ...
          <p>
            👑 Top Scorer: <span className="font-semibold text-blue-500">{messiStats.topScorer} time</span>
          </p>
        </div>
      </div>
