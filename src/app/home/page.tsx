  ...
  return (
    <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-800'} min-h-screen flex flex-col relative overflow-hidden transition-colors duration-500`}>
      ...
      <div className="flex flex-col relative z-10 container mx-auto">
        {/* <h1 className="text-4xl text-center font-bold mb-6 text-red-600 tracking-widest uppercase">Welcome to the Leo Messi Page</h1> */}
        <div className='flex flex-col md:flex-row mb-12 items-center'>
  {/* Imagen 1 */}
  <div className='w-full md:w-1/2 mb-6 md:mb-0 md:mr-6 relative transition-transform duration-300'
    style={{
      borderRadius: '0% 100% 100% 0% / 35% 0% 100% 50%',
      overflow: 'hidden',
      width: '800px',  // Ajusta el ancho de la imagen según sea necesario
      height: '500px', // Ajusta la altura de la imagen según sea necesario
    }}
  >
    <Image src={Portada} alt={'Messi'} layout="responsive" className="filter grayscale" />
    <div className="absolute inset-0 bg-black opacity-50"></div>
  </div>

  {/* Texto 1 */}
  <div className='w-full md:w-1/2 mt-4 bg-opacity-10 backdrop-filter backdrop-blur-lg border-white border-opacity-20'>
    ...
    <p className='text-justify leading-relaxed'>
      A los 13 años, el destino le tenía preparado un giro que cambiaría su vida para siempre. Messi dejó su Argentina natal y partió hacia Barcelona, España, para unirse a La Masia, la prestigiosa academia juvenil del FC Barcelona. La transición no fue fácil; extrañaba su tierra, su familia, pero el sueño de conquistar el fútbol europeo lo impulsaba a superar cualquier obstáculo.
        ...
        {/* Segundo Bloque */}
        <div className='flex flex-col md:flex-row-reverse mb-12 items-center'>
          {/* Imagen 2 (en el lado izquierdo) */}
          <div className='w-full md:w-1/3 rounded-lg overflow-hidden mb-6 md:mb-0 md:mr-6 relative transform hover:scale-105 transition-transform duration-300'>
            <Image src={MessiFr} alt={'Messi'} layout="responsive" className="rounded-lg filter grayscale" />
            <div className="absolute inset-0 bg-black opacity-50"></div>
          </div>

          {/* Texto 2 (en el lado derecho) */}
          <div className='w-full md:w-2/3 mt-4 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-6 rounded-lg border border-white border-opacity-20'>
            <p className='text-justify mb-4 leading-relaxed'>
        ...
        <div className='flex flex-col md:flex-row mb-12 items-center'>
          ...
          <div className='w-full md:w-1/2 rounded-lg overflow-hidden mb-6 md:mb-0 md:mr-6 relative transform hover:scale-105 transition-transform duration-300'>
            <Image src={Masia} alt={'Messi'} layout="responsive" className="rounded-lg filter grayscale" />
            <div className="absolute inset-0 bg-black opacity-50"></div>
          </div>

          {/* Texto 3 (en el lado derecho) */}
          <div className='w-full md:w-1/2 mt-4 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-6 rounded-lg border border-white border-opacity-20'>
            <p className='text-justify mb-4 leading-relaxed'>
